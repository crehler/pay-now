...
<h1 align="center">Zwroty płatności PayNow</h1>

<p align="center">Pełne i częściowe zwroty pieniędzy klientowi — wykonywane wprost z panelu Shopware, bez logowania do panelu PayNow.</p>
...
- Zamówienie musi być **opłacone** przez PayNow.
- **Klucz API** użyty w konfiguracji wtyczki (produkcyjny lub sandbox) musi mieć po stronie PayNow włączoną obsługę **zwrotów**. Jeśli zwroty nie są aktywne dla danego sklepu/klucza, bramka odrzuci żądanie — skontaktuj się wtedy z PayNow.
...
- Czas zaksięgowania zwrotu po stronie banku/operatora zależy od PayNow i banku klienta.
